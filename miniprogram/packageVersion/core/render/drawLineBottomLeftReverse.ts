...
export default class DrawLineBottomLeftReverse extends AngleRender implements drawAngle {
    ...
    setAngle(angle: number) {
        ...
        this.startY = this.height * 0.9
        this.endX = this.width * 0.15
        this.endY = this.height * 0.66
    ...
    private drawValueShapArrow() {
        drawArrow(this.pointer, this.ctx, this.startX, this.startY - 17.5 * rpx, Math.PI)
    }
